...
export type ColivingLeafletMapProps = {
  name: string;
  locality: string;
  city: string;
  address: string;
...
export function ColivingLeafletMap({
  name,
  locality,
  city,
  address,
  ...
  return (
    <div className={className}>
      <div className="relative h-64 w-full overflow-hidden rounded-2xl border border-slate-200/80 bg-[#ebe6dc] sm:h-72">
